#!/usr/bin/env python3
"""
IVAS 键盘控制器 - 通过键盘发送任务指令到 Mock Server

默认连接本地 Mock Server (localhost:5001)，无需环境变量配置。

使用方法：
    python ivas/keyboard_commander.py              # 默认连接 localhost:5001
"""
import sys
import os
import requests
...
def main():
    ...
    console.print(Panel.fit(
        ...
        f"[dim]模式: [bold cyan]Mock 模式[/bold cyan][/dim]",
        border_style="cyan"
    ))
    console.print()
