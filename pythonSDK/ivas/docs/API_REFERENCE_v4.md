...
- `1`: 原地起飞10米 (需指定ID，可指定所有无人机)
- `2`: 无人机原地降落 (需指定ID，可指定所有无人机)，对应油门持续下拉
- `3`: 返航 (需指定ID，可指定所有无人机)，触发返航mqtt return_home
- `4`: 前往某个指定点 (需指定ID，不能指定所有无人机，需要提供经纬高辅助量), 触发mqtt_flyto
- `5`: 执行预设多航点任务1 (需指定ID，不能指定所有无人机),执行Trajectory/uav1.json
- `6`: 执行预设多航点任务2 (需指定ID，不能指定所有无人机),执行Trajectory/uav2.json
- `7`: 执行预设多航点任务3 (需指定ID，不能指定所有无人机),执行Trajectory/uav3.json
  **响应示例**
